...
**This version:** \
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; https://spec.canvasprotocol.org/v0.7.1 \
**Latest version:** \
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; https://spec.canvasprotocol.org/v0.7.1 \
**Previous version:** \
...
**Legal**:
Open Canvas Interchange Format (OCIF) v0.7.1 © 2025-2026 by Open Canvas Working Group is licensed under CC BY-SA 4.0. To view a copy of this licence, visit https://creativecommons.org/licenses/by-sa/4.0/
...
- [Appendix](#appendix)
  ...
  - [Changes](#changes)
    - [From v0.6 to v0.7.1](#from-v06-to-v070)
...
- **OCIF**: The _Open Canvas Interchange Format_ schema URI.
  ...
  - Known versions:
    ...
    - `https://canvasprotocol.org/ocif/v0.7.1` Is the current version. Note the simplified URI format.
...
- URI: `https://spec.canvasprotocol.org/v0.7.1/extensions/canvas-viewport.json`
...
- Name: `@ocif/rect`
- URI: `https://spec.canvasprotocol.org/v0.7.1/extensions/rect.json`
...
- Name: `@ocif/oval`
- URI: `https://spec.canvasprotocol.org/v0.7.1/extensions/oval.json`
- Usage: On a [node](#nodes).
...
- Name: `@ocif/arrow`
- URI: `https://spec.canvasprotocol.org/v0.7.1/extensions/arrow.json`
- Usage: On a [node](#nodes).
...
- Name: `@ocif/path`
- URI: `https://spec.canvasprotocol.org/v0.7.1/extensions/path.json`
- Usage: On a [node](#nodes).
...
- Name: `@ocif/ports`
- URI: `https://spec.canvasprotocol.org/v0.7.1/extensions/ports.json`
- Usage: On a [node](#nodes).
...
- URI: `https://spec.canvasprotocol.org/v0.7.1/extensions/global-positions.json`
- Usage: On a [node](#nodes).
...
- URI: `https://spec.canvasprotocol.org/v0.7.1/extensions/anchored-node.json`
- Usage: On a [node](#nodes).
...
- Name: `@ocif/textstyle`
- URI: `https://spec.canvasprotocol.org/v0.7.1/extensions/textstyle.json`
- Usage: On a [node](#nodes).
...
- URI: `https://spec.canvasprotocol.org/v0.7.1/extensions/theme-define.json`
- Usage: On a [node](#nodes).
...
- Name: `@ocif/theme-use`
- URI: `https://spec.canvasprotocol.org/v0.7.1/extensions/theme-use.json`
- Usage: On a [node](#nodes).
...
- Name: `@ocif/inherit`
- URI: `https://spec.canvasprotocol.org/v0.7.1/extensions/inherit.json`
- Usage: On a [node](#nodes).
...
- Name: `@ocif/page`
- URI: `https://spec.canvasprotocol.org/v0.7.1/extensions/page.json`
- Usage: On a [node](#nodes).
...
- Name: `@ocif/group`
- URI: `https://spec.canvasprotocol.org/v0.7.1/extensions/group.json`
- Usage: On a [node](#nodes).
...
- Name: `@ocif/edge`
- URI: `https://spec.canvasprotocol.org/v0.7.1/extensions/edge.json`
- Usage: On a [node](#nodes).
...
- Name: `@ocif/hyperedge`
- URI: `https://spec.canvasprotocol.org/v0.7.1/extensions/hyperedge.json`
- Usage: On a [node](#nodes).
...
Any [Schema Name](#schema-name) of the form `@ocif/{name}` maps to a schema [URI](#uri) `https://spec.canvasprotocol.org/v0.7.1/extensions/{name}.json`.
...
```json
{
  "schemas": [
    {
      "name": "@ocif/${name}",
      "uri": "https://spec.canvasprotocol.org/v0.7.1/extensions/${name}.json"
    }
  ]
}
```

Here `v0.7.1` is the current version identifier of the OCIF spec. Later OCIF specs will have different versions and thus different URIs.
...
- schema.json, which contains the JSON schema for the extension.
  ...
  - It MAY have a `title`. If a title is used, it should match the proposed short name, e.g. `@ocif/oval` or `@ocif/ports/v0.7.1`.
...
- Name: `@ocif/data`
- URI: `https://spec.canvasprotocol.org/v0.7.1/extensions/data.json`
...
{
  "schemas": [
    { "name": "@ocif/anchored-node", "uri": "https://spec.canvasprotocol.org/v0.7.1/extensions/anchored-node.json" },
    { "name": "@ocif/arrow", "uri": "https://spec.canvasprotocol.org/v0.7.1/extensions/arrow.json" },
    {
      "name": "@ocif/canvas-viewport",
      "uri": "https://spec.canvasprotocol.org/v0.7.1/extensions/canvas-viewport.json"
    },
    { "name": "@ocif/data", "uri": "https://spec.canvasprotocol.org/v0.7.1/extensions/data.json" },
    { "name": "@ocif/edge", "uri": "https://spec.canvasprotocol.org/v0.7.1/extensions/edge.json" },
    {
      "name": "@ocif/global-positions",
      "uri": "https://spec.canvasprotocol.org/v0.7.1/extensions/global-positions.json"
    },
    { "name": "@ocif/group", "uri": "https://spec.canvasprotocol.org/v0.7.1/extensions/group.json" },
    { "name": "@ocif/hyperedge", "uri": "https://spec.canvasprotocol.org/v0.7.1/extensions/hyperedge.json" },
    { "name": "@ocif/inherit", "uri": "https://spec.canvasprotocol.org/v0.7.1/extensions/inherit.json" },
    { "name": "@ocif/oval", "uri": "https://spec.canvasprotocol.org/v0.7.1/extensions/oval.json" },
    { "name": "@ocif/page", "uri": "https://spec.canvasprotocol.org/v0.7.1/extensions/page.json" },
    { "name": "@ocif/path", "uri": "https://spec.canvasprotocol.org/v0.7.1/extensions/path.json" },
    { "name": "@ocif/ports", "uri": "https://spec.canvasprotocol.org/v0.7.1/extensions/ports.json" },
    { "name": "@ocif/rect", "uri": "https://spec.canvasprotocol.org/v0.7.1/extensions/rect.json" },
    { "name": "@ocif/textstyle", "uri": "https://spec.canvasprotocol.org/v0.7.1/extensions/textstyle.json" },
    { "name": "@ocif/theme-define", "uri": "https://spec.canvasprotocol.org/v0.7.1/extensions/theme-define.json" },
    { "name": "@ocif/theme-use", "uri": "https://spec.canvasprotocol.org/v0.7.1/extensions/theme-use.json" }
  ]
}
```
...
- `https://spec.canvasprotocol.org` - specification; REDIRECT to the latest version, e.g. `https://spec.canvasprotocol.org/v0.7.1/spec.md`
- `https://spec.canvasprotocol.org/v0.7.1/spec.md` - OCIF specification version; this is also its [URI](#uri). Links in the text to the schema.
- `https://spec.canvasprotocol.org/v0.7.1/schema.json` - General OCIF JSON schema
- Extension URIs (some selected exemplars):
  - `https://spec.canvasprotocol.org/v0.7.1/extensions/rect.json` - URI for the rectangle extension
  - `https://spec.canvasprotocol.org/v0.7.1/extensions/edge.json` - URI for the edge extension
