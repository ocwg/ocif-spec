...
# Entity
OCIF uses abstract base types called *entity* and *item*.
The *entity* type allows for extension data and comments.
A direct sub-type of *entity* is [representation](#representation).
